...
class thirdques extends StatefulWidget {
  @override
  _thirdquesState createState() => _thirdquesState();
}
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    _buildRadioListTile('V3: Dry, cracked, cold, rough',
                        'V3: Dry, cracked, cold, rough'),
                    _buildRadioListTile('P3: Red, dark', 'P3: Red, dark'),
                    _buildRadioListTile('K3:White, slimy (thin layer)',
                        'K3:White, slimy (thin layer)'),
                  ],
                ),
                SizedBox(height: 20),
