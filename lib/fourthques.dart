...
class fourthques extends StatefulWidget {
  @override
  _fourthquesState createState() => _fourthquesState();
}
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    _buildRadioListTile(
                        'V4: Dry, small, rough, discolored, cracked ',
                        'V4: Dry, small, rough, discolored, cracked '),
                    _buildRadioListTile('P4: Pinkish', 'P4: Pinkish'),
                    _buildRadioListTile('K4: Soft, oily, smooth, white, steady',
                        'K4: Soft, oily, smooth, white, steady'),
                  ],
                ),
                SizedBox(height: 20),
