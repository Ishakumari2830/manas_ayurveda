...
class sixthques extends StatefulWidget {
  @override
  _sixthquesState createState() => _sixthquesState();
}
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    _buildRadioListTile(
                        'V6: Less, disturbed,', 'V6: Less, disturbed,'),
                    _buildRadioListTile('P6: Moderate,', 'P6: Moderate,'),
                    _buildRadioListTile('K6: Sleepy, loves sleeping',
                        'K6: Sleepy, loves sleeping'),
                  ],
                ),
                SizedBox(height: 20),
